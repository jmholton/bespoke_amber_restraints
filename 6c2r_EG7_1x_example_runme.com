#! /bin/tcsh -f
# 6c2r_EG7_1x_example_runme.com
# Aurora Kinase A with EG7 inhibitor — single unit cell (super_mult=1,1,1) crystallographic Amber MD
...
NOTE: no starter kit at $skit — running fully standalone.
  Ligand and salt parameters will be generated on the fly (elbow if it works,
  otherwise antechamber AM1-BCC), and HIS protonation is determined by QM.
  That setup is slower, and EG7 gets the PDB monomer-library protonation rather
  than a curated one.  To use a kit instead, symlink it and point skit at it:
